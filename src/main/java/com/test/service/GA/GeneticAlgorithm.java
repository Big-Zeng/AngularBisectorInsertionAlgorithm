...
public class GeneticAlgorithm {
    ...
    private static final float DEFAULT_CROSSOVER_PROBABILITY = 0.95f; // 默认交叉概率
    private static final float DEFAULT_MUTATION_PROBABILITY = 0.25f; // 默认突变概率
    private static final int DEFAULT_POPULATION_SIZE = 50; // 默认种群数量
    ...
    private int mutationTimes = 500; // 变异次数
    private int currentGeneration = 1; // 当前的一代
    private int maxGeneration =3500; // 最大代数

    private int pointNum;
    private int[][] population; // 种群集
    private int[][] dist; // 点集间的邻接矩阵
