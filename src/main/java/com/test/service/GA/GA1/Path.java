...
public class Path{
	...
	public double crossOverValue = 0.9;
	...
	public Town [] crossOver(Path partner){
		...
		try{
	    	...
	    	Integer n = (Math.random()<crossOverValue) ? new Integer(towns[0].id) : new Integer(partner.towns[0].id);
