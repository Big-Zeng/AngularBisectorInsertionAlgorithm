...
public class Node {
	 ...
	 */
	public Node(Node parent, double parent_cost, int[][] distances, int[] active_set, int index) {
		this.parent = parent;
	...
	public boolean isTerminal2() {
		return  active_set.length <= 2;
	}
	...
	public double getLowerBound() {
		...
		double value1 = getParentCost() + value / 2;
	...
	public double getPathCost() {
		...
		return distances[Solver.startIndex][index] + getParentCost();
	}
