...
public class InOut {
    ...
    public static int max_tries; /* maximum number of independent tries */
    ...
    public static double time_used; /* time used until some given event */
    ...
    static Point[] read_etsp(String tsp_file_name) throws IOException
    /*
    ...
    public static void set_default_parameters()
    /*
	...
	LocalSearch.dlb_flag = true; /* apply don't look bits in local search */
	LocalSearch.nn_ls = 20; /* use fixed radius search in the 20 nearest neighbours */
	Ants.n_ants = 10; /* number of ants */
	Ants.nn_ants = 4; /* number of nearest neighbours in tour construction */
	Ants.alpha = 1.0;
	Ants.beta = 2.0;
	Ants.rho = 0.5;
	Ants.q_0 = 0.0;
	...
	try {
		name_buf = "E:\\Paper\\otherAlogrithm\\ACOTSPJava-master\\tsp\\eil51.tsp";
