...
public class Tsp {
	...
	public Point[] nodeptr; /* array of structs containing coordinates of nodes */
	public int[][] distance; /* distance matrix: distance[i][j] gives distance */
    ...
    public static int[][] compute_nn_lists()
    /*
